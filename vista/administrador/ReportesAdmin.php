...
require("../../modelo/GestionAdmin.php");
$usuarios = new Admin();
...
$fpdf->SetFontSize(20);
$fpdf->Cell(0, 20, "Reportes Admin", 0, 0, "C");
...
foreach ($datos as $personas) {
    ...
    $fpdf->Cell(20, 10, " " . $personas['Rol']  ." ", 1, 0, "L",1); 
    $fpdf->Ln(); 
}
