...
<body>
    ...
    <form action="../controlador/CompraProducto.php" method="post">
        ...
        <input type="text" name="producto_id" id="producto_id" value="<?php echo $_GET["idproducto"] ?>" readonly>
        <br>
        <label for="">Cantidad</label>
        <input type="number" name="cantidad" id="cantidad" value="1">
        <br>
        <label for="">Precio</label>
        <input type="text" name="precio_unitario" id="precio_unitario" value="<?php echo $_GET["precio"] ?>" readonly>
        <br>
