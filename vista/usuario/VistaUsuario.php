        ...
        <?php foreach ($matriz as $producto): ?>
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    echo $precio_total;
                    ?>$</p>
                    <a href="../controlador/VistaCompraProducto.php?idproducto=<?php echo $producto['IdProducto'] ?>&precio=<?php echo $producto['precio']; ?>"><input type="button" value="Comprar" class="btn btn-primary"></a>
                </div>
